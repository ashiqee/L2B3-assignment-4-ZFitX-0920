    ...
    <div>
      ...
      <div className="container  mx-auto grid grid-cols-2 gap-6">
        <div className="p-10 py-14">
          ...
          <Link to="/cart">
            <Label className="flex gap-4 my-10 items-center">
              {' '}
          ...
          <div className="flex justify-between  items-center">
            <div className="flex gap-4 items-center">
              <div className="relative">
                <img className="w-20  object-cover h-20 rounded-lg" src={img} />
                ...
                <div className="flex gap-2 items-center">
                  <RadioGroup defaultValue="option-one">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label className='flex gap-2 items-center' htmlFor="option-two">Pay with <img className='w-20 h-12' src='https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Stripe_Logo%2C_revised_2016.svg/2560px-Stripe_Logo%2C_revised_2016.svg.png'/></Label>
                    </div>
                  </RadioGroup>
                </div>
